...
import { useTraktSettings } from "@/shared/lib/queries"
...
describe("Lists page", () => {
  ...
  it("shows a loading message while the settings query is pending", () => {
    vi.mocked(useTraktSettings).mockReturnValue(queryResult(undefined, true))
    render(<Lists />)
